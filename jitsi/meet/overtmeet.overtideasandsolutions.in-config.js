...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'overtmeet.overtideasandsolutions.in',

        // When using authentication, domain for guest users.
        anonymousdomain: 'guest.overtmeet.overtideasandsolutions.in',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'overtmeet.overtideasandsolutions.in',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.overtmeet.overtideasandsolutions.in',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'overtmeet.overtideasandsolutions.in',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://overtmeet.overtideasandsolutions.in/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://overtmeet.overtideasandsolutions.in/' + subdir + 'xmpp-websocket',
    enableUserRolesBasedOnToken: true,
    // The real JID of focus participant - can be overridden here
    // Do not change username - FIXME: Make focus username configurable
    // https://github.com/jitsi/jitsi-meet/issues/7376
    // focusUserJid: 'focus@auth.overtmeet.overtideasandsolutions.in',
    ...
    //     // by default uses:
    //     // 'https://overtmeet.overtideasandsolutions.in/static/oauth.html'
    //     redirectURI:
    //          'https://overtmeet.overtideasandsolutions.in/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:overtmeet.overtideasandsolutions.in:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.overtmeet.overtideasandsolutions.in',
